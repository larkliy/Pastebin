...
public interface IUserService
{
    ...
    Task<PaginatedResponse<FoundedUserResponse>> GetUsersAsync(int pageNumber, int pageSize, CancellationToken cancellationToken = default);
    Task<UserResponse> UpdateUserByIdAsync(Guid userId, Guid currentUserId, UpdateUserRequest updateRequest, CancellationToken cancellationToken = default);
    Task DeleteUserByIdAsync(Guid userId, Guid currentUserId, CancellationToken cancellationToken = default);
}
